...
plt.savefig(figures_path + "flux_partitioning_observations.pdf", dpi=600, bbox_inches='tight')
plt.close()
...
plt.savefig(figures_path + "flux_partitioning_observations_scatter.pdf", dpi=600, bbox_inches='tight')
plt.close()